...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $projets = $em->getRepository('TestBundle:Projet')->findAll();
    ...
    {
        $projet = new Projet();
        $form = $this->createForm('TestBundle\Form\ProjetType', $projet);
    ...
    {
        $deleteForm = $this->createDeleteForm($projet);
        $editForm = $this->createForm('TestBundle\Form\ProjetType', $projet);
